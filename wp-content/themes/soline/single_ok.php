              ...
              <h1><?=the_title();?></h1>
                    ...
                    $(document).ready(function() {
                     	$('.foto').click(function(event){
										 ...
										 $.fn.colorbox({width:"450px", height:"600px", iframe:true, href: link, 
										 })
                    ...
                    -->
                     ...
                     <div class="pikachoose" style="width:320px">
                             ...
                             echo "tamanho".strlen($filename);
    												
    												 if(strlen($filename)>0):
    												?>
    												 <a class="colorbox" href="<?=$array_images_gd[0]?>"><img src="<?=$primeira_imagem?>" alt="<?=the_title();?>"/></a>
    												<? else: ?>
                ...
                <ul class="produtos">
                  ...
                  ?>
                        <li>
                           ...
                           <img src="<?php $values = get_post_custom_values("thumb"); 
                        $imagem =imagem($values[0]); 
                       $explode = explode(".",$imagem); $img_redim =  $explode[0].".".$explode[1].".".$explode[2].".".$explode[3]."-150x150".".".$explode[4];
                        echo $img_redim; ?>" alt="<?php the_title(); ?>" width="150" height="150" />
