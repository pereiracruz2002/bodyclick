...
?>
     <div id="conteudo" class="produto">
        <?php if ( have_posts() ) while ( have_posts() ) : the_post(); 
                ...
                $caminho_img = $_SERVER['DOCUMENT_ROOT']."/soline/".$explode_img[3]."/".$explode_img[4]."/".$explode_img[5]."/".$explode_img[6]."/".$final[0]."-400x400.".$final[1];
                ...
                <ul class="produtos">
                  ...
                  ?>
                        <li>
                          ...
                          $caminho_img = $_SERVER['DOCUMENT_ROOT']."/soline/".$explode_img[3]."/".$explode_img[4]."/".$explode_img[5]."/".$explode_img[6]."/".$final[0]."-199x214.".$final[1];
                          if(file_exists($caminho_img)){
